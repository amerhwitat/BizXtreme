...
let t=0; renderer.setAnimationLoop(time=>{t=time*.001; ring.rotation.z=t*.35; beacon.position.y=3.5+Math.sin(t*2)*.15; camera.position.x=Math.sin(t*.08)*1.8; camera.lookAt(0,2,-5); renderer.render(scene,camera)});
