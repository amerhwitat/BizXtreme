...
PRODUCTS = {
    "starter_pack": {"type": "consumable", "price": 0.99}, "builder_pack": {"type": "consumable", "price": 4.99},
    "tycoon_premium": {"type": "non_consumable", "price": 9.99}, "vip_monthly": {"type": "subscription", "price": 4.99, "period": "month"},
    "medical_kit": {"type": "consumable", "price": 0.49}, "ammo_pack": {"type": "consumable", "price": 0.29}, "survival_bundle": {"type": "consumable", "price": 0.69},
}
...
class MonetizationEngine:
    ...
    def purchase(self, product_id, provider="store"):
        ...
        return {"ok":True,"product_id":product_id,"provider":provider,"amount":product["price"],"status":"verification-required","payment_methods":{"ethereum":{"asset":"ETH","recipient":routing["primaryEthAddress"]},"paypal":{"account":routing["primaryPayPalAccount"]}},"default_payment_method":routing["defaultMethod"],"fallback_payment_method":routing["fallbackMethod"],"requires_explicit_user_selection":routing["routingRequiresExplicitUserSelection"]}
    def record_ad_impression(self, placement, provider):
        ...
        self.events.append({"type":"ad_impression","placement":placement,"provider":provider,"test_mode":self.test_mode}); return {"ok":True,"placement":placement,"provider":provider}
    def grant_rewarded_ad(self, placement, reward):
        ...
        self.events.append({"type":"rewarded_ad","placement":placement,"reward":reward,"test_mode":self.test_mode}); return {"ok":True,"reward":reward}
