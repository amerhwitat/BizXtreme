...
public final class TycoonGame {
    ...
    public TycoonGame(long cash) { this.cash = cash; }
    ...
    public TurnResult advanceTurn() {
        long revenue=0,costs=0; for (var e:owned.entrySet()) { var b=BUSINESSES.get(e.getKey()); revenue+=b.revenue()*e.getValue(); costs+=b.costs()*e.getValue(); }
        cash += revenue-costs; turn++; return new TurnResult(turn,revenue,costs,revenue-costs,cash);
    }
